...
const AttendanceHistory = () => {
  ...
  const getStatusBadge = (
    ...
    return (
      <Badge
        variant="outline"
        className={`${config.color} px-2 sm:px-3 py-0.5 sm:py-1 text-[10px] sm:text-xs`}
      >
    ...
    <div className="min-h-screen bg-gray-50 p-3 sm:p-4 md:p-6 lg:p-8">
      ...
      <div className="flex flex-col items-center justify-center gap-3 mb-4 sm:mb-6 md:mb-8 text-center relative">
        <div className="w-full">
          <h1 className="text-xl sm:text-2xl md:text-3xl font-bold text-gray-900 mb-1 sm:mb-2 text-center">
            Attendance History
          </h1>
          <p className="text-xs sm:text-sm md:text-base text-gray-600 text-center">
            View and manage attendance records for your batch
          </p>
        </div>
        <div className="sm:absolute sm:right-0 sm:top-0 flex items-center gap-2 sm:gap-3">
          <Button
            variant="ghost"
            size="icon"
            className="h-8 w-8 sm:h-10 sm:w-10 text-indigo-600 hover:text-indigo-700 hover:bg-indigo-50"
          >
          ...
          <CardContent className="p-3 sm:p-4 md:p-6">
            <div className="flex items-start justify-between">
              <div className="min-w-0">
                <p className="text-[9px] sm:text-[10px] md:text-xs font-semibold text-gray-500 uppercase tracking-wider mb-1 sm:mb-2">
                  TOTAL
                </p>
                <p className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 mb-0.5 sm:mb-1 md:mb-2">
                  {stats.total}
                </p>
                <p className="text-[9px] sm:text-xs md:text-sm text-gray-600 truncate">
                  All time
                </p>
              </div>
          ...
          <CardContent className="p-3 sm:p-4 md:p-6">
            <div className="flex items-start justify-between">
              <div className="min-w-0">
                ...
                <p className="text-[9px] sm:text-xs md:text-sm text-orange-600 font-medium truncate">
                  Attention
                </p>
              </div>
          ...
          <CardContent className="p-3 sm:p-4 md:p-6">
            <div className="flex items-start justify-between">
              <div className="min-w-0">
                ...
                <p className="text-[9px] sm:text-xs md:text-sm text-red-600 font-medium truncate">
                  Follow up
                </p>
              </div>
                ...
                <Table>
                  <TableHeader>
                    <TableRow className="bg-gray-50 border-b border-gray-100">
                      ...
                      <TableHead className="font-semibold text-[10px] sm:text-xs text-gray-500 uppercase tracking-wider py-2 sm:py-3 hidden lg:table-cell text-left">
                        Date & Time
                      </TableHead>
                      <TableHead className="font-semibold text-[10px] sm:text-xs text-gray-500 uppercase tracking-wider py-2 sm:py-3 text-left">
                        Status
                      ...
                      >
                        <TableCell className="py-2 sm:py-3 md:py-4 text-left">
                          <div className="flex items-center gap-2 sm:gap-3">
                            <Avatar
                              className={`w-7 h-7 sm:w-8 sm:h-8 md:w-10 md:h-10 ${getAvatarColor(index)} flex-shrink-0`}
                            >
                        ...
                        <TableCell className="py-2 sm:py-3 md:py-4 text-left">
                          {getStatusBadge(record.finalStatus)}
                        </TableCell>
                        <TableCell className="py-2 sm:py-3 md:py-4 hidden sm:table-cell text-left">
                          {record.approvedByMentor ? (
                            <Badge
                              variant="outline"
                              className="bg-blue-100 text-blue-700 border-blue-200 px-2 sm:px-3 py-0.5 sm:py-1 text-[10px] sm:text-xs"
                            >
                              Approved
                            </Badge>
                          ) : (
                            <Badge
                              variant="outline"
                              className="bg-gray-100 text-gray-600 border-gray-200 px-2 sm:px-3 py-0.5 sm:py-1 text-[10px] sm:text-xs"
                            >
                              Pending
                            </Badge>
                          )}
