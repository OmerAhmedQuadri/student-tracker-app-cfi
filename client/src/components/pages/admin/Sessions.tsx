...
import { BookOpen, Plus, Calendar, Users, Pencil, Trash2, Loader2, Clock, X, MoreVertical } from 'lucide-react';
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
                    <div className="flex flex-col md:flex-row md:items-center md:justify-between">
                        <div>
                            ...
                            <p className="mt-1 text-sm text-gray-500">Schedule and manage mentorship sessions</p>
                        </div>
                        ...
                        <CardContent className="p-5">
                            <div className="flex items-center justify-between">
                                <div>
                                    ...
                                    <p className="text-2xl font-bold text-gray-900 mt-1">{pastSessions.length}</p>
                                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <Card className="shadow-sm border border-gray-200">
                        <CardHeader className="border-b border-gray-100 bg-gray-50/50">
                            ...
                            <CardDescription className="text-xs">Scheduled mentorship sessions</CardDescription>
                        </CardHeader>
                            ...
                            <div className="space-y-4">
                                    ...
                                    >
                                        <div className="flex items-start justify-between">
                                            <div className="flex-1">
                                                <h3 className="text-base font-semibold text-gray-900 mb-2">{session.topic}</h3>
                                                ...
                                                <div className="flex flex-wrap gap-4 text-sm">
                                                    ...
                                                    <div className="flex items-center gap-2 text-gray-600">
                                                        ...
                                                        <span>{new Date(session.date).toLocaleTimeString('en-US', { 
                                                            hour: '2-digit',
                                                            minute: '2-digit'
                                                        })}</span>
                                                    </div>
                                ...
                                {upcomingSessions.length === 0 && (
                                    <div className="text-center py-12">
                                        ...
                                        <p className="text-gray-500 text-sm mt-1">Schedule a new session to get started</p>
                                    </div>
                                )}
                            </div>
                        </CardContent>
                    ...
                    <Card className="shadow-sm border border-gray-200">
                        <CardHeader className="border-b border-gray-100 bg-gray-50/50">
                            <CardTitle className="text-base font-semibold">Past Sessions</CardTitle>
                            <CardDescription className="text-xs">Completed mentorship sessions</CardDescription>
                        </CardHeader>
                            ...
                            <div className="space-y-4">
                                ...
                                {pastSessions.length === 0 && (
                                    <div className="text-center py-12">
                                        ...
                                        <p className="text-gray-900 font-medium">No past sessions</p>
                                        <p className="text-gray-500 text-sm mt-1">Completed sessions will appear here</p>
                                    </div>
                                )}
                            </div>
                        </CardContent>
                        ...
                        <CardHeader className="border-b border-gray-100 bg-gray-50/50">
                            <div className="flex items-center justify-between">
                                <div>
                                    ...
                                    <CardDescription className="text-xs">Schedule a mentorship session</CardDescription>
                                </div>
                                <Button 
                                    variant="ghost" 
                                    size="sm" 
                            ...
                            <form onSubmit={handleCreateSession} className="space-y-4">
                                <div>
                                    ...
                                    <Input
                                        id="batchId"
                                        placeholder="Batch 1"
                                        className={`mt-1 ${formErrors.batchId ? 'border-red-300 focus:border-red-500 focus:ring-red-500' : ''}`}
                                ...
                                <div>
                                    ...
                                    <Input
                                        ...
                                        className={`mt-1 ${formErrors.topic ? 'border-red-300 focus:border-red-500 focus:ring-red-500' : ''}`}
