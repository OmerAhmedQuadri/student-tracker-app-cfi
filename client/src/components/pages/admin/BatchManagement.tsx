...
import { Layers, Users, GraduationCap, School, Loader2, ChevronDown, ChevronUp, X } from 'lucide-react';
...
const BatchManagement = () => {
    ...
    const handleCreateBatch = async () => {
        ...
        if (batches.some(b => b.batchId.toLowerCase() === newBatchId.trim().toLowerCase())) {
        ...
        try {
            ...
            toast.success(`Batch "${newBatchId}" created and assigned to ${selectedMentorIds.length} mentor(s)!`);
                        ...
                        <div className="p-6 max-h-[70vh] overflow-y-auto">
                            <div className="mb-5">
                                ...
                                <Input
                                    ...
                                    onKeyDown={(e) => e.key === 'Enter' && !creating && handleCreateBatch()}
                                                ...
                                                <input
                                                    ...
                                                    onChange={(e) => {
                                                        if (e.target.checked) {
                                                            ...
                                                            setSelectedMentorIds(selectedMentorIds.filter(id => id !== mentor._id));
                                                        }
                                                    }}
                                                    disabled={creating}
                                                    ...
                                                    {mentor.batchIds && mentor.batchIds.length > 0 && (
                                                        <div className="flex flex-wrap gap-1 mt-1">
                                                            {mentor.batchIds.map(batchId => (
                                                                <Badge key={batchId} variant="outline" className="text-xs bg-purple-50 text-purple-600 border-purple-200">
                                                                    {batchId}
                                                                </Badge>
                                                            ))}
                                                        </div>
                            ...
                            <div className="flex justify-end gap-2 pt-4 border-t border-gray-100">
                                ...
                                <Button 
                                    ...
                                    disabled={creating || !newBatchId.trim() || selectedMentorIds.length === 0}
