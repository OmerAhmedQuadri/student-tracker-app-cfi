            ...
            <Card className="border-none shadow-lg bg-white">
              <CardContent className="p-4 flex items-center justify-between">
                <p className="text-sm text-gray-600">
                  You have{" "}
                  <span className="font-bold text-gray-900">{unreadCount}</span>{" "}
            ...
            {loading ? (
              ...
              <div className="divide-y divide-gray-100">
                {notifications.map((notification) => (
                  ...
                  >
                    <div
                      className={`p-2 rounded-lg ${notification.isRead ? "bg-gray-100" : "bg-white shadow-sm"}`}
                    >
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-start justify-between gap-4">
                        <div className="flex-1">
                          <h3
                            className={`font-semibold ${!notification.isRead ? "text-gray-900" : "text-gray-600"}`}
                          >
                            {notification.title}
                          </h3>
                          <p
