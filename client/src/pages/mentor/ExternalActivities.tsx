                        ...
                        <div className="flex flex-col gap-2 shrink-0">
                          ...
                          {activity.status === "pending" && (
                            <>
                              <Button
                                size="icon"
                                className="h-9 w-9 rounded-lg bg-green-500 text-white hover:bg-green-600"
                                onClick={() =>
                              ...
                              <Button
                                size="icon"
                                className="h-9 w-9 rounded-lg bg-red-500 text-white hover:bg-red-600"
                                onClick={() =>
                ...
                <div className="flex items-center justify-between px-6 py-4 border-t border-gray-100">
                  ...
                  <div className="flex items-center gap-2">
                    <Button
                      ...
                      className="text-gray-600 border-gray-200 hover:bg-gray-50 disabled:opacity-50"
                    >
                      Previous
                    </Button>
                    <Button
