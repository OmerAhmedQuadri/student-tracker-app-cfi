...
import { Shield, Search, AlertTriangle, CheckCircle, XCircle, Info, Filter } from 'lucide-react';
            ...
            <div className="relative h-48 bg-gradient-to-br from-red-600 via-orange-600 to-amber-600 overflow-hidden">
                ...
                <div className="max-w-7xl mx-auto px-6 h-full flex items-center relative z-10">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h1 className="text-3xl font-black text-white tracking-tight">Security Logs</h1>
                            <p className="text-orange-100 text-sm mt-1">Monitor system security events and activities</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
                    <Card className="border-none shadow-xl bg-white">
                        <CardContent className="p-4">
                            <div className="flex items-center justify-between">
                                <div>
                                    <p className="text-xs font-semibold text-gray-500 uppercase">Success</p>
                                    <p className="text-2xl font-black text-gray-900 mt-1">{statusCounts.success}</p>
                                </div>
                        ...
                        <CardContent className="p-4">
                            <div className="flex items-center justify-between">
                                <div>
                                    ...
                                    <p className="text-2xl font-black text-gray-900 mt-1">{statusCounts.warning}</p>
                                </div>
                        ...
                        <CardContent className="p-4">
                            <div className="flex items-center justify-between">
                                <div>
                                    ...
                                    <p className="text-2xl font-black text-gray-900 mt-1">{statusCounts.error}</p>
                                </div>
                    ...
                    <Card className="border-none shadow-xl bg-white">
                        <CardContent className="p-4">
                            <div className="flex items-center justify-between">
                                <div>
                                    <p className="text-xs font-semibold text-gray-500 uppercase">Info</p>
                                    <p className="text-2xl font-black text-gray-900 mt-1">{statusCounts.info}</p>
                                </div>
                ...
                <Card className="border-none shadow-xl bg-white">
                    <CardHeader className="bg-gradient-to-r from-red-50 to-orange-50 border-b">
                        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                            <div>
                                <CardTitle className="text-base font-bold">Security Events</CardTitle>
                                <CardDescription className="text-xs">Recent security-related activities</CardDescription>
                            </div>
